...
- [Hermes OpenAI Codex Web Search](https://github.com/bart6114/hermes-openai-codex-web-search) by [bart6114](https://github.com/bart6114) — Adds OpenAI Codex hosted search as a Hermes web-search backend using an existing ChatGPT/Codex sign-in instead of a separate search API key; calls use the user's subscription capacity. **[beta]**
