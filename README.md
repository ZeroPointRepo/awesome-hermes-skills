...
- [hermes-audio-visualizer](https://github.com/caesarjue/hermes-audio-visualizer) by [caesarjue](https://github.com/caesarjue) — System-audio-driven rainbow spectrum in the Hermes Desktop status bar: 48 bars plus a window-edge glow, local-only FFT, ships the main-process loopback patch it needs. **[beta]**
