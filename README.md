...
- [orca-replay](https://github.com/Continuum-AI-Corp/OrcaReplay/tree/main/skills/orca-replay) by [Continuum-AI-Corp](https://github.com/Continuum-AI-Corp) — Answers "why did that past run do this" from the run's recording instead of from memory, and replays it offline or forks it onto another model. Needs the orcareplay MCP server. **[experimental]**
