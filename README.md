...
- [Cohesivity](https://github.com/cohesivity-org/cohesivity-plugin) by [Cohesivity](https://github.com/cohesivity-org) — cohesivity.ai offers free agent native backend services. Anonymous account (no-signup) to get started through MCP or API. Hosting, postgres, email, storage, containers, LLMs, voice and third-party APIs. Includes free tiers and 5 USD/mo in AI and Search credits. Top-ups through x402. **[beta]**
