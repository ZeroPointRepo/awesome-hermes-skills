...
- [hermes-plugin-netbox](https://github.com/andrewvieyra/hermes-plugin-netbox) by [andrewvieyra](https://github.com/andrewvieyra) — NetBox change management: reviewed field-level diffs, journaled apply with automatic rollback, and rollback of applied plans. **[beta]**
