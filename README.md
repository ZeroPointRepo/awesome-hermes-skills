...
- [hermes-artifact-relay](https://github.com/eloktev/hermes-artifact-relay) by [eloktev](https://github.com/eloktev) — Publishes long Markdown and standalone HTML from Hermes to a private self-hosted library, with separate publish/view credentials and expiring artifact links. **[beta]**
