...
- [candor-finance](https://github.com/candorsystems/candor-finance/tree/main/skills/candor-finance) by [Candor Systems](https://github.com/candorsystems) — Gives Hermes connected financial records and persistent context for spending reviews, budgets, and goals through Candor’s remote MCP server. **[beta]**
